 ...
 * @brief Implementation of LLVOAvatarDefines class
 *
...
LLVOAvatarDictionary::Textures::Textures()
{
	...
	addEntry(TEX_UPPER_SHIRT,		new TextureEntry("shirt",			TRUE,	BAKED_NUM_INDICES, "UIImgDefaultShirtUUID",		LLWearableType::WT_SHIRT));
	addEntry(TEX_LOWER_PANTS,		new TextureEntry("pants",			TRUE,	BAKED_NUM_INDICES, "UIImgDefaultPantsUUID",		LLWearableType::WT_PANTS));
	addEntry(TEX_EYES_IRIS,			new TextureEntry("iris",			TRUE,	BAKED_NUM_INDICES, "UIImgDefaultEyesUUID",		LLWearableType::WT_EYES));
	addEntry(TEX_HAIR,				new TextureEntry("hair",			TRUE,	BAKED_NUM_INDICES, "UIImgDefaultHairUUID",		LLWearableType::WT_HAIR));
	...
	addEntry(TEX_LOWER_SHOES,		new TextureEntry("shoes",			TRUE,	BAKED_NUM_INDICES, "UIImgDefaultShoesUUID",		LLWearableType::WT_SHOES));
	addEntry(TEX_LOWER_SOCKS,		new TextureEntry("socks",			TRUE,	BAKED_NUM_INDICES, "UIImgDefaultSocksUUID",		LLWearableType::WT_SOCKS));
	...
	addEntry(TEX_UPPER_GLOVES,		new TextureEntry("gloves",			TRUE,	BAKED_NUM_INDICES, "UIImgDefaultGlovesUUID",	LLWearableType::WT_GLOVES));
	addEntry(TEX_UPPER_UNDERSHIRT,	new TextureEntry("undershirt",		TRUE,	BAKED_NUM_INDICES, "UIImgDefaultUnderwearUUID",	LLWearableType::WT_UNDERSHIRT));
	addEntry(TEX_LOWER_UNDERPANTS,	new TextureEntry("underpants",		TRUE,	BAKED_NUM_INDICES, "UIImgDefaultUnderwearUUID",	LLWearableType::WT_UNDERPANTS));
...
{
	// Baked textures
	addEntry(BAKED_HEAD,	new BakedEntry(TEX_HEAD_BAKED, "head",
										   "a4b9dc38-e13b-4df9-b284-751efb0566ff",
										   3, TEX_HEAD_BODYPAINT,
											  TEX_HEAD_TATTOO,
											  TEX_HEAD_ALPHA,
										   5, LLWearableType::WT_SHAPE,
											  LLWearableType::WT_SKIN,
											  LLWearableType::WT_HAIR,
											  LLWearableType::WT_TATTOO,
											  LLWearableType::WT_ALPHA));

	addEntry(BAKED_UPPER,	new BakedEntry(TEX_UPPER_BAKED, "upper_body",
	...
	addEntry(BAKED_LOWER,	new BakedEntry(TEX_LOWER_BAKED, "lower_body",
	...
	addEntry(BAKED_EYES,	new BakedEntry(TEX_EYES_BAKED, "eyes",
										   "27b1bc0f-979f-4b13-95fe-b981c2ba9788",
										   2, TEX_EYES_IRIS,
											  TEX_EYES_ALPHA,
										   2, LLWearableType::WT_EYES,
											  LLWearableType::WT_ALPHA));

	addEntry(BAKED_SKIRT,	new BakedEntry(TEX_SKIRT_BAKED, "skirt",
										   "03e7e8cb-1368-483b-b6f3-74850838ba63",
										   1, TEX_SKIRT,
										   1, LLWearableType::WT_SKIRT));

	addEntry(BAKED_HAIR,	new BakedEntry(TEX_HAIR_BAKED, "hair",
										   "a60e85a9-74e8-48d8-8a2d-8129f28d9b61",
										   2, TEX_HAIR,
											  TEX_HAIR_ALPHA,
										   2, LLWearableType::WT_HAIR,
											  LLWearableType::WT_ALPHA));
}
