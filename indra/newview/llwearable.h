...
private:
	...
	// Ansariel: Must be public for importtracker
...
public:
	...
	void					setType(LLWearableType::EType type)		{ mType = type; }
...
public:
	...
	static void			removeFromAvatar(LLWearableType::EType type, BOOL set_by_user); 
